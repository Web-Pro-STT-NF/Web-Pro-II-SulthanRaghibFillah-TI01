	...
	return /******/ (function (modules) {
		...
		/******/ [
				...
				var Extension = (function () {
					...
					function Extension(colorpicker) {
						...
						this.colorpicker.element.on(
							...
							_jquery2.default.proxy(this.onCreate, this)
						);
						this.colorpicker.element.on(
							"colorpickerDestroy.colorpicker-ext",
							_jquery2.default.proxy(this.onDestroy, this)
						);
						this.colorpicker.element.on(
							"colorpickerUpdate.colorpicker-ext",
							_jquery2.default.proxy(this.onUpdate, this)
						);
						this.colorpicker.element.on(
							"colorpickerChange.colorpicker-ext",
							_jquery2.default.proxy(this.onChange, this)
						);
						this.colorpicker.element.on(
							"colorpickerInvalid.colorpicker-ext",
							_jquery2.default.proxy(this.onInvalid, this)
						);
						this.colorpicker.element.on(
							"colorpickerShow.colorpicker-ext",
							_jquery2.default.proxy(this.onShow, this)
						);
						this.colorpicker.element.on(
							"colorpickerHide.colorpicker-ext",
							_jquery2.default.proxy(this.onHide, this)
						);
						this.colorpicker.element.on(
							"colorpickerEnable.colorpicker-ext",
							_jquery2.default.proxy(this.onEnable, this)
						);
						this.colorpicker.element.on(
							"colorpickerDisable.colorpicker-ext",
							_jquery2.default.proxy(this.onDisable, this)
						);
					}
						...
						[
							...
							},
							{
								...
								value: function string() {
									...
									format = ColorItem.sanitizeFormat(
							...
							},
							{
								...
								value: function equals(color) {
									color =
										color instanceof ColorItem ? color : new ColorItem(color);
							...
							},
							{
								...
								value: function generate(formula) {
									...
									if (Array.isArray(formula)) {
										...
										throw new Error(
											"No color formula found with the name '" + formula + "'."
										);
									} else {
			...
			/***/ function (module, exports, __webpack_require__) {
				...
				var sliderSize =
					sassVars.bar_size_short * sassVars.columns +
					sassVars.base_margin * (sassVars.columns - 1);
				...
				var Palette = (function (_Extension) {
					...
					function Palette(colorpicker) {
						...
						var _this = _possibleConstructorReturn(
							this,
							(Palette.__proto__ || Object.getPrototypeOf(Palette)).call(
								this,
								colorpicker,
						...
						if (
							!Array.isArray(_this.options.colors) &&
							_typeof(_this.options.colors) !== "object"
						) {
						...
						},
						{
							...
							value: function getName(value) {
								...
								for (var name in this.options.colors) {
									...
									if (
										this.options.colors[name].toLowerCase() ===
										value.toLowerCase()
									) {
										return name;
									}
					...
					function Colorpicker(element, options) {
						...
						this.container =
							this.container !== false
								? (0, _jquery2.default)(this.container)
								: false;
					...
					_createClass(Colorpicker, [
						...
						},
						{
							...
							value: function initExtensions() {
								...
								this.options.extensions.forEach(function (ext) {
									_this.registerExtension(
										Colorpicker.extensions[ext.name.toLowerCase()],
										ext.options || {}
									);
								});
							},
						...
						},
						{
							...
							value: function setValue(val) {
								...
								ch.color = val
									? ch.createColor(val, this.options.autoInputFallback)
									: null;
			...
			/***/ function (module, exports, __webpack_require__) {
				...
				var Debugger = (function (_Extension) {
					...
					function Debugger(colorpicker) {
						...
						var _this = _possibleConstructorReturn(
							this,
							(Debugger.__proto__ || Object.getPrototypeOf(Debugger)).call(
								this,
								colorpicker,
								options
							)
						...
						if (_this.colorpicker.inputHandler.hasInput()) {
							_this.colorpicker.inputHandler.input.on(
								"change.colorpicker-ext",
								_jquery2.default.proxy(_this.onChangeInput, _this)
							);
						}
						return _this;
					}
					...
					_createClass(Debugger, [
						...
						},
						{
							...
							value: function onCreate(event) {
								...
								return _get(
									Debugger.prototype.__proto__ ||
										Object.getPrototypeOf(Debugger.prototype),
									"onCreate",
									this
								).call(this, event);
							},
			...
			/***/ function (module, exports, __webpack_require__) {
				...
				var Preview = (function (_Extension) {
					...
					function Preview(colorpicker) {
						...
						var _this = _possibleConstructorReturn(
							this,
							(Preview.__proto__ || Object.getPrototypeOf(Preview)).call(
								this,
								colorpicker,
					...
					_createClass(Preview, [
						{
							...
							value: function onCreate(event) {
								_get(
									Preview.prototype.__proto__ ||
										Object.getPrototypeOf(Preview.prototype),
									"onCreate",
									this
								).call(this, event);
			...
			/***/ function (module, exports, __webpack_require__) {
				...
				var Swatches = (function (_Palette) {
					...
					function Swatches(colorpicker) {
						...
						var _this = _possibleConstructorReturn(
							this,
							(Swatches.__proto__ || Object.getPrototypeOf(Swatches)).call(
								this,
								colorpicker,
								_jquery2.default.extend(true, {}, defaults, options)
							)
					...
					_createClass(Swatches, [
						...
						},
						{
							...
							value: function onCreate(event) {
								_get(
									Swatches.prototype.__proto__ ||
										Object.getPrototypeOf(Swatches.prototype),
									"onCreate",
									this
								).call(this, event);
						...
						},
						{
							...
							value: function load() {
								...
								var colorpicker = this.colorpicker,
									swatchContainer = this.element.find(
										".colorpicker-swatches--inner"
									),
									isAliased =
										this.options.namesAsValues === true &&
										!Array.isArray(this.colors);

								swatchContainer.empty();

								_jquery2.default.each(this.colors, function (name, value) {
									var $swatch = (0, _jquery2.default)(
										_this2.options.swatchTemplate
									)
										.attr("data-name", name)
								...
								swatchContainer.append(
									(0, _jquery2.default)('<i class="colorpicker-clear"></i>')
								);
							},
						},
					]);
				...
				var SliderHandler = (function () {
					...
					_createClass(SliderHandler, [
						...
						},
						{
							key: "bind",
							value: function bind() {
								var sliders = this.colorpicker.options.horizontal
								...
								this.colorpicker.picker
									.find(sliderClasses.join(", "))
									.on(
										"mousedown.colorpicker touchstart.colorpicker",
										_jquery2.default.proxy(this.pressed, this)
									);
							},
						...
						},
						{
							...
							value: function unbind() {
								(0, _jquery2.default)(this.colorpicker.picker).off({
									"mousemove.colorpicker": _jquery2.default.proxy(
										this.moved,
										this
									),
									"touchmove.colorpicker": _jquery2.default.proxy(
										this.moved,
										this
									),
									"mouseup.colorpicker": _jquery2.default.proxy(
										this.released,
										this
									),
									"touchend.colorpicker": _jquery2.default.proxy(
										this.released,
										this
									),
								});
							...
							value: function pressed(e) {
								...
								for (var sliderName in sliders) {
									...
									if (zone.is(slider.selector)) {
										...
										slider.childSelector !== undefined &&
										zone.is(slider.childSelector)
									) {
										this.currentSlider = _jquery2.default.extend({}, slider, {
											name: sliderName,
										});
								 ...
								 */
								(0, _jquery2.default)(this.colorpicker.picker)
									.on({
										"mousemove.colorpicker": _jquery2.default.proxy(
											this.moved,
											this
					...
					_createClass(PopupHandler, [
						{
							...
							value: function bind() {
								...
								if (this.hasAddon) {
									...
									this.addon.on({
										"mousedown.colorpicker touchstart.colorpicker":
											_jquery2.default.proxy(this.toggle, this),
									});

									this.addon.on({
										"focus.colorpicker": _jquery2.default.proxy(
											this.show,
											this
										),
									});
									...
									this.addon.on({
										"focusout.colorpicker": _jquery2.default.proxy(
											this.hide,
											this
										),
									});
								...
								if (this.hasInput && !this.hasAddon) {
									this.input.on({
										"mousedown.colorpicker touchstart.colorpicker":
											_jquery2.default.proxy(this.show, this),
										"focus.colorpicker": _jquery2.default.proxy(
											this.show,
											this
										),
								...
								(0, _jquery2.default)(this.root).on(
									"resize.colorpicker",
									_jquery2.default.proxy(this.reposition, this)
								);
							},
						...
						},
						{
							...
							value: function unbind() {
								...
								(0, _jquery2.default)(this.root).off(
									"resize.colorpicker",
									_jquery2.default.proxy(this.reposition, this)
								);
								...
								(0, _jquery2.default)(this.root.document).off(
									"mousedown.colorpicker touchstart.colorpicker",
									_jquery2.default.proxy(this.onClickingInside, this)
								);
							},
						},
						{
						...
						},
						{
							...
							value: function isOrIsInside(container, element) {
								...
								return (
									element.is(container) || container.find(element).length > 0
								);
							},
						},
						{
							...
							value: function createPopover() {
								...
								this.popoverTarget.popover(
									_jquery2.default.extend(
										true,
										{},
										_options2.default.popover,
										cp.options.popover,
										{ trigger: "manual", content: cp.picker, html: true }
									)
								);

								this.popoverTip = (0, _jquery2.default)(
									this.popoverTarget.popover("getTipElement").data("bs.popover")
										.tip
								);
								...
								this.popoverTarget.on(
									"shown.bs.popover",
									_jquery2.default.proxy(this.fireShow, this)
								);
								this.popoverTarget.on(
									"hidden.bs.popover",
									_jquery2.default.proxy(this.fireHide, this)
								);
							},
						...
						},
						{
							...
							value: function show(e) {
								...
								if (
									e &&
									(!this.hasInput || this.input.attr("type") === "color") &&
									e &&
									e.preventDefault
								) {
									e.stopPropagation();
				...
				var InputHandler = (function () {
					...
					function InputHandler(colorpicker) {
						...
						this.input = this.colorpicker.element.is("input")
							...
							? this.colorpicker.element.find(this.colorpicker.options.input)
							: false;
					...
					_createClass(InputHandler, [
						{
							...
							value: function bind() {
								...
								this.input.on({
									"keyup.colorpicker": _jquery2.default.proxy(
										this.onkeyup,
										this
									),
								});
								this.input.on({
									"change.colorpicker": _jquery2.default.proxy(
										this.onchange,
										this
									),
								});
						...
						},
						{
							...
							value: function _initValue() {
								...
								if (val instanceof _ColorItem2.default) {
									val = this.getFormattedColor(
										val.string(this.colorpicker.format)
									);
								} else if (
						...
						},
						{
							...
							value: function getFormattedColor() {
								...
								val = val
									? val
									: this.colorpicker.colorHandler.getColorString();

								if (!val) {
									return "";
								}

								val = this.colorpicker.colorHandler.resolveColorDelegate(
									val,
									false
								);
					...
					_createClass(ColorHandler, [
						...
						},
						{
							...
							value: function createColor(val) {
								var fallbackOnInvalid =
									arguments.length > 1 && arguments[1] !== undefined
										? arguments[1]
										: true;

								var color = new _ColorItem2.default(
									this.resolveColorDelegate(val),
									this.format
								);
						...
						},
						{
							...
							value: function getFallbackColor() {
								...
								if (!color.isValid()) {
									...
									return this.color
										? this.color
										: new _ColorItem2.default("#000000", this.format);
								}
						...
						},
						{
							...
							set: function set(value) {
								...
								if (
									value instanceof _ColorItem2.default &&
									this.colorpicker.options.format === "auto"
								) {
					...
					_createClass(PickerHandler, [
						{
							...
							value: function bind() {
								 ...
								 */
								var picker = (this.picker = (0, _jquery2.default)(
						...
						},
						{
							...
							value: function attach() {
								...
								var pickerParent = this.colorpicker.container
						...
						},
						{
							...
							value: function update() {
								...
								var saturationGuide = this.picker.find(
										".colorpicker-saturation .colorpicker-guide"
									),
									hueGuide = this.picker.find(
										".colorpicker-hue .colorpicker-guide"
									),
									alphaGuide = this.picker.find(
								...
								if (hueGuide.length) {
									hueGuide.css(
										vertical ? "top" : "left",
										(vertical ? slider.hue.maxTop : slider.hue.maxLeft) *
											(1 - hsva.h)
									);
								}
								if (alphaGuide.length) {
									alphaGuide.css(
										vertical ? "top" : "left",
										(vertical ? slider.alpha.maxTop : slider.alpha.maxLeft) *
											(1 - hsva.a)
									);
								}
								if (saturationGuide.length) {
									saturationGuide.css({
										top:
											slider.saturation.maxTop -
											hsva.v * slider.saturation.maxTop,
