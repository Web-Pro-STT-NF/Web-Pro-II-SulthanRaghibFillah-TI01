...
(function webpackUniversalModuleDefinition(root, factory) {
	...
	return (function (modules) {
		...
		function (module, exports, __webpack_require__) {
			...
			var Extension = (function () {
				...
				_createClass(Extension, [
					...
					{ key: "onCreate", value: function onCreate(event) {} },
					{
						key: "onDestroy",
					...
					{ key: "onUpdate", value: function onUpdate(event) {} },
					{ key: "onChange", value: function onChange(event) {} },
					{ key: "onInvalid", value: function onInvalid(event) {} },
					{ key: "onHide", value: function onHide(event) {} },
					{ key: "onShow", value: function onShow(event) {} },
					{ key: "onDisable", value: function onDisable(event) {} },
					{ key: "onEnable", value: function onEnable(event) {} },
				]);
				return Extension;
			})();
					...
					[
						{
							...
							value: function replace(color) {
								...
								this._original = { color, format, valid: true };
		...
		function (module, exports, __webpack_require__) {
			"use strict";
			Object.defineProperty(exports, "__esModule", { value: true });
			var sassVars = { bar_size_short: 16, base_margin: 6, columns: 6 };
			var sliderSize =
			...
			exports.default = {
				...
				extensions: [{ name: "preview", options: { showText: true } }],
				sliders: {
					saturation: {
		...
		function (module, exports, __webpack_require__) {
			...
			var defaults = { colors: null, namesAsValues: true };
				...
				_createClass(Debugger, [
					{
						...
						value: function log(eventName) {
							...
							this.colorpicker.element.trigger({
								...
								color: this.color,
								value: null,
								debug: { debugger: this, eventName, logArgs: args, logMessage },
							});
						},
					},
					{
					...
					},
					{
						...
						value: function bind() {
							this.addon = this.colorpicker.options.addon
								? this.colorpicker.element.find(this.colorpicker.options.addon)
								: null;
