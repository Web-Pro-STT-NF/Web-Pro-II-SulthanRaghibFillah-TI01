                ...
                <div class="col-12">
                   <form method="POST" action="<?= base_url('Master/faskes_save') ?>" class="was-validated" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                         ...
                         <textarea name="alamat" id="alamat" cols="30" rows="2" class="form-control" placeholder="Tulis Alamat Fasilitas Kesehatan" required></textarea>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                         ...
                         <input id="latlong" name="latlong" placeholder="Tulis Latlong Fasilitas Kesehatan" type="text" class="form-control" required>
                      </div>
                      <div class="form-group">
                         <label for="deskripsi" class="form-label">Deskripsi</label>
                         <textarea name="deskripsi" id="deskripsi" cols="30" rows="2" class="form-control" placeholder="Tulis Deskripsi Fasilitas Kesehatan" required></textarea>
                      </div>
                      <div class="form-group">
